...
This is a companion project to my [KCorp Enterprise IAM Lab](#), which covers identity infrastructure (Active Directory, Entra ID, hybrid identity). This repo focuses on the support side instead: how tickets get triaged, worked, and resolved, and how that work gets documented for reuse.
